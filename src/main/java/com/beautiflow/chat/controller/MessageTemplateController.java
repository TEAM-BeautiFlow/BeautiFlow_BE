...
public class MessageTemplateController {
	...
	@PostMapping
	public ResponseEntity<ApiResponse<Void>> createTemplate(@RequestBody MessageTemplateCreateReq req, @RequestParam Long ownerId) {
		templateService.create(ownerId, req);
		return ResponseEntity.ok(ApiResponse.successWithNoData());
	}

	@Operation(summary = "내 템플릿 목록 조회", description = "현재 로그인된 사용자의 템플릿 목록을 조회합니다.")
	@GetMapping
	public ResponseEntity<ApiResponse<List<MessageTemplateRes>>> getMyTemplates(@RequestParam Long ownerId) {
