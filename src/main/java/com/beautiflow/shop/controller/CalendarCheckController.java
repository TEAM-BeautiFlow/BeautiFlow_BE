...
public class CalendarCheckController {
  ...
  @Operation(summary = "시간대별 예약 현황 조회", description = "특정 날짜에 예약된 시간대별 세부내역을 조회합니다.")
  ...
  public ResponseEntity<ApiResponse<Page<ReservationListRes>>> getReservationsByDate(
    ...
    Page<ReservationListRes> result = calendarCheckService.getReservationsByDate(designerId, date, pageable);
    return ResponseEntity.ok(ApiResponse.success(result));
  }
